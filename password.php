...
<body class="h-100 body ">
    ...
    <input type="hidden"  value="<?php pass($db_connection); ?>" id="pass">
...
<form id="passwordform" style="margin-top: 150px;" method="POST" action="index.php">
                <div class="form-group ">
                  <label for="oldpass">Enter Old Password</label>
                  <input type="password" class="form-control col-sm-9  " id="oldpass" name="oldpass" placeholder="Old Password" required>
                </div>
                <div class="form-group">
                  <label for="newpass1">Enter New Password</label>
                  <input type="password" class="form-control col-sm-9" id="newpass1" name="newpass1" placeholder="New Password" required>
                </div>
                <div class="form-group">
                  <label for="newpass2">Enter your New Password again</label>
                  <input type="password" class="form-control col-sm-9" id="newpass2" name="newpass2" placeholder="Confirm Password" required>
                </div>
                <div class="form-group">
                <button id="save" type="submit" name="save" class="btn btn-primary col-auto ">Save</button>
                <button id="reset" type="reset" name="reset" class="btn btn-danger col-auto ">Clear</button>
                </div>
              </form>
              </div>
    </div>
